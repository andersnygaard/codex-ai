...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/ScriptOutline/generate',
            ...(fetchMiddlewares<RequestHandler>(ScriptOutlineController)),
            ...(fetchMiddlewares<RequestHandler>(ScriptOutlineController.prototype.generateScript)),

            async function ScriptOutlineController_generateScript(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
            };
